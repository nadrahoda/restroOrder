...
router.push('/')
  ...
  const [food,setFood] = useState('');
   ...
   <center>
     <h1 className="mt-32 text-2xl font-extrabold mb-32  text-black  dark:text-white md:text-2xl lg:text-5xl"> <span className="text-transparent bg-clip-text bg-gradient-to-r to-emerald-600 from-sky-400">Confirm Your Order</span></h1>
