...
const MyOrder = () => {
 ...
 <center>
   <h1 className="mt-32 text-2xl font-extrabold mb-32  text-black  dark:text-white md:text-2xl lg:text-5xl"> <span className="text-transparent bg-clip-text bg-gradient-to-r to-emerald-600 from-sky-400">Your Order</span></h1>
  ...
  <h1 className=" text-2xl font-extrabold mb-32  text-black  dark:text-white md:text-2xl lg:text-5xl">Status: <span className={`${status=='Confirmed'? `text-green-500`:`text-red-500`}`}>{status}</span></h1>
